        ...
        media_list = [
            {
                'id': video[0],
                'title': video[1],
                'file_path': f"http://localhost:5000/videos/{os.path.basename(video[2])}",  # Updated to full URL
                'thumbnail_path': f"http://localhost:5000/thumbnails/{os.path.basename(video[3])}",  # Updated to full URL
                'category': video[4]
            }
            for video in videos
        ]
